...
| [caf.cvt](https://github.com/Transport-for-the-North/caf.cvt/)               | Climate Vulnerability model to assign climate hazard risks to the transport network.                                                                                                                                                                                       | Climate modelling        | Code, CLI      | Release | Python   |
