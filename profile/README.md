...
| [caf.mat](https://github.com/Transport-for-the-North/caf.mat/)               | Python package for reading, writing and performing calculations with transport modelling matrices. We aim to provide a consistent method for interacting with transport matrices from Python, providing front-end features for common matrix operations.                        | Transport modelling and analysis                                | Code, CLI      | Beta      | Python     |
